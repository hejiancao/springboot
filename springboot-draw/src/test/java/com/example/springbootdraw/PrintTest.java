...
/**
 * Created by shaosen on 2022/7/21
 */
@SpringBootTest(classes = PrintTest.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
...
public class PrintTest {
    ...
    public void testPrint() throws Exception {
        ...
        String printerName = "PDF";//打印机名包含字串
